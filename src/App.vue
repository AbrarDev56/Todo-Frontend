            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" type="button" data-bs-toggle="modal" data-bs-target="#exampleModala">
                                Add a Collection
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a v-if="!isAuthenticated" @click="next()" class="nav-link" type="button">
                                <span class="ml-2 text-capitalize">{{ mode }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <RouterLink v-if="!isAuthenticated" to="/signup" class="nav-link">Register</RouterLink>
                        </li>
